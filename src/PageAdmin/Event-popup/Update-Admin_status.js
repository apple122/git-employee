...
const Update_admin = () => {
    return (
        <>
            <div class="modal fade staticBackdrop" id="Update_admin" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="staticBackdropLabel"><strong><i class="bi bi-person-lines-fill"></i> ຈັດການແກ້ໄຂຂໍ້ມູນ ສະຖານະຜູ້ຂາຍ</strong></h4>
