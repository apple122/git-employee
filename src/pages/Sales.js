...
const Salses = () => {
    ...
    return (
        ...
        <div className="container-content colums-group-padding">
                ...
                <div className="col-md-6">
                    <div class="nav group-event-table">
                        <div className="nav respon-ul-link label-font-12 item-align-end">
                            ...
                            <div class="nav-item position-right li-link-border-mb" role="presentation">
                                <Link to="/Sales" class="nav-link li-link-border active respon-li btn-sm" id="no_submit" >ຖອນເຄື່ອງ</Link>
                            </div>
                            <div class="nav-item position-right li-link-border-mb" role="presentation">
                                <Link to="/History_revoke" class="nav-link li-link-border respon-li btn-sm" id="all">ປະຫວັດຖອນ</Link>
                            </div>
            ...
            <div className=""><strong>ລາຍການການຖອນເຄື່ອງ ລວມ ( <label className="color-danger">{showWithdraw.filter((e) => Moment(e.createdAt).format("YYYY-MM-DD") === today).length}</label> ) ວັນນີ້</strong></div>
